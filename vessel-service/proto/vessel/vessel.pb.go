...
type Vessel struct {
	...
	Capacity  int32  `protobuf:"varint,2,opt,name=capacity,proto3" json:"capacity,omitempty"`                    // 最大容量(船体容量即是集装箱的个数)
	MaxWeight int32  `protobuf:"varint,3,opt,name=max_weight,json=maxWeight,proto3" json:"max_weight,omitempty"` // 最大载重
	Name      string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                             // 名字
	Available bool   `protobuf:"varint,5,opt,name=available,proto3" json:"available,omitempty"`                  // 是否可用
	OwerId    string `protobuf:"bytes,6,opt,name=ower_id,json=owerId,proto3" json:"ower_id,omitempty"`           // 归属
}
...
func (x *Vessel) GetOwerId() string {
	if x != nil {
		return x.OwerId
	}
	return ""
...
type Specification struct {
	...
	Capacity  int32 `protobuf:"varint,1,opt,name=capacity,proto3" json:"capacity,omitempty"`                    // 容量（内部集装箱的个数）
	MaxWeight int32 `protobuf:"varint,2,opt,name=max_weight,json=maxWeight,proto3" json:"max_weight,omitempty"` // 重量
}
...
var file_proto_vessel_vessel_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x67, 0x6f, 0x2e,
	0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x72, 0x76, 0x2e, 0x76, 0x65, 0x73, 0x73, 0x65, 0x6c,
	0x22, 0x9e, 0x01, 0x0a, 0x06, 0x56, 0x65, 0x73, 0x73, 0x65, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	,
	...
	,
