...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e,
	...
	0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e,
	...
	0x32, 0x25, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e,
...
var file_proto_consignment_consignment_proto_goTypes = []interface{}{
	(*Consignment)(nil), // 0: go.micro.crv.consignment.Consignment
	(*Container)(nil),   // 1: go.micro.crv.consignment.Container
	(*Response)(nil),    // 2: go.micro.crv.consignment.Response
	(*GetRequest)(nil),  // 3: go.micro.crv.consignment.GetRequest
}
var file_proto_consignment_consignment_proto_depIdxs = []int32{
	1, // 0: go.micro.crv.consignment.Consignment.containers:type_name -> go.micro.crv.consignment.Container
	0, // 1: go.micro.crv.consignment.Response.consignment:type_name -> go.micro.crv.consignment.Consignment
	0, // 2: go.micro.crv.consignment.Response.consignments:type_name -> go.micro.crv.consignment.Consignment
	0, // 3: go.micro.crv.consignment.ShippingService.CreateConsignment:input_type -> go.micro.crv.consignment.Consignment
	3, // 4: go.micro.crv.consignment.ShippingService.GetConsignments:input_type -> go.micro.crv.consignment.GetRequest
	2, // 5: go.micro.crv.consignment.ShippingService.CreateConsignment:output_type -> go.micro.crv.consignment.Response
	2, // 6: go.micro.crv.consignment.ShippingService.GetConsignments:output_type -> go.micro.crv.consignment.Response
