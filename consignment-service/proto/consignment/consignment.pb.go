...
type Consignment struct {
	...
	Containers  []*Container `protobuf:"bytes,4,rep,name=containers,proto3" json:"containers,omitempty"`             // 货物包含的集装箱
...
type Response struct {
	...
	Consignment  *Consignment   `protobuf:"bytes,2,opt,name=consignment,proto3" json:"consignment,omitempty"`   // 新托运的货物
	Consignments []*Consignment `protobuf:"bytes,3,rep,name=consignments,proto3" json:"consignments,omitempty"` // 目前所有托运的货物
}
...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x22,
	0x0c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb9, 0x01,
	...
	0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x69,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xb8, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	...
	0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f,
	...
	0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72, 0x76, 0x2e, 0x63, 0x6f, 0x6e, 0x73,
	0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6e, 0x6d,
	0x65, 0x6e, 0x74, 0x1a, 0x22, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63,
	...
	0x73, 0x74, 0x1a, 0x22, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x63, 0x72,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x2f,
...
var file_proto_consignment_consignment_proto_goTypes = []interface{}{
	(*GetRequest)(nil),  // 0: go.micro.crv.consignment.GetRequest
	(*Consignment)(nil), // 1: go.micro.crv.consignment.Consignment
	(*Container)(nil),   // 2: go.micro.crv.consignment.Container
	(*Response)(nil),    // 3: go.micro.crv.consignment.Response
}
var file_proto_consignment_consignment_proto_depIdxs = []int32{
	2, // 0: go.micro.crv.consignment.Consignment.containers:type_name -> go.micro.crv.consignment.Container
	1, // 1: go.micro.crv.consignment.Response.consignment:type_name -> go.micro.crv.consignment.Consignment
	1, // 2: go.micro.crv.consignment.Response.consignments:type_name -> go.micro.crv.consignment.Consignment
	1, // 3: go.micro.crv.consignment.ShippingService.CreateConsignment:input_type -> go.micro.crv.consignment.Consignment
	0, // 4: go.micro.crv.consignment.ShippingService.GetConsignments:input_type -> go.micro.crv.consignment.GetRequest
	3, // 5: go.micro.crv.consignment.ShippingService.CreateConsignment:output_type -> go.micro.crv.consignment.Response
	3, // 6: go.micro.crv.consignment.ShippingService.GetConsignments:output_type -> go.micro.crv.consignment.Response
...
func (c *shippingServiceClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/go.micro.crv.consignment.ShippingService/CreateConsignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetConsignments(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/go.micro.crv.consignment.ShippingService/GetConsignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShippingService_CreateConsignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.crv.consignment.ShippingService/CreateConsignment",
	}
...
func _ShippingService_GetConsignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.crv.consignment.ShippingService/GetConsignments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ShippingService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "go.micro.crv.consignment.ShippingService",
